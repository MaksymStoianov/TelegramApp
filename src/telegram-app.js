...
TelegramApp.Telegram = class Telegram {
  ...
  /**
   * Устанавливет интеграцию с веб-перехватчиком.
   * @param {string} url
   ...
   * @param {BotCommand[]} commands Список команд бота, сериализованный в формате JSON, который должен быть установлен как список команд бота. Можно указать не более 100 команд.
   * @param {Object} [options={}] Опциональные параметры.
   * @return {boolean}
   */
   ...
   * @param {strinng} text Новый текст сообщения.
   * @param {Object} [options={}] Опциональные параметры.
   ...
   * @param {InputMedia} media JSON-сериализованный объект для нового мультимедийного содержимого сообщения.
   * @param {Object} [options={}] Опциональные параметры.
   * @return {boolean}
   */
